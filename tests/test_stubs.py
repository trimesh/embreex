...
import glob
import pytest
from package.generate_stubs import generate_stubs, EMBREEX_DIR
...
def test_stubs_are_synchronized(tmp_path):
    ...
    assert temp_pyi_files, "No type stub (.pyi) files were generated. Check Cython source files in embreex/."
